...
This folder contains a full-stack web application (frontend and backend).

Quick start (local development):

1. Install dependencies for Frontend and Backend.

2. Start the backend and frontend according to their package.json scripts.

See the `Frontend` and `Backend` folders for per-service details.

Note: This repository is an imported project prepared for local development.
npm run dev
```
...
Create a docker-compose.yml file in the project folder. Write the following in it.
